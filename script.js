document.addEventListener("DOMContentLoaded", () => {
  ...
  function homeIntro() {
    ...
    const heroH1 = document.querySelector(
      ".home_hero_wrap h1.heading-style-display"
    );
    const homeParagraph = document.querySelector(
      ".home_hero_wrap .home_hero_paragraph"
    );
    const buttonGroupEl = document.querySelector(
      ".home_hero_wrap .button-group"
    );
